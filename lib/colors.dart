...
// class AppColor {
//   static Color homePageBackground = Colors.white;
//   static Color homePageTitle = Colors.black;
//   static Color homePageSubTitle = Colors.black54;
//   static Color homePageDetails = const Color.fromARGB(255, 85, 55, 255);
//   static Color homePageIcons = Colors.black;
//   static Color homepageContainerTextSmall = Colors.white;
//   static Color gradientFirst = Color.fromARGB(255, 16, 0, 73);
//   static Color gradientSecond = const Color.fromARGB(255, 101, 163, 255);
// }
